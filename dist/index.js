...
function typewrite() {
    ...
    typewriter.pauseFor(2500).typeString("<p>A simple yet powerful native javascript</p>").pauseFor(300).deleteChars(10).typeString("plugin for a cool typewriter effect and ").typeString("<p>hihbiob</p>").pauseFor(1000).start();
}
